...
/*
**  037 is & but is also used as filler for unused codes
*/
const u8 asciiToExtBcd[256] =
    {   
    /*                                                                         */
    /* 000- */ 037, 037, 037, 037, 037, 037, 037, 037,
    /*                                                                         */
    /* 010- */ 037, 037, 037, 037, 037, 037, 037, 037,
    /*                                                                         */
    /* 020- */ 037, 037, 037, 037, 037, 037, 037, 037,
    /*                                                                         */
    /* 030- */ 037, 037, 037, 037, 037, 037, 037, 037,
    /*          space   !       "       #       $       %       &       '      */
    /* 040- */ 020, 052, 014, 036, 053, 016, 037, 055,
    /*          (       )       *       +       ,       -       .       /      */
    /* 050- */ 034, 074, 054, 060, 033, 040, 073, 021,
    /*          0       1       2       3       4       5       6       7      */
    /* 060- */ 012, 001, 002, 003, 004, 005, 006, 007,
    /*          8       9       :       ;       <       =       >       ?      */
    /* 070- */ 010, 011, 000, 077, 072, 013, 057, 056,
    /*          @       A       B       C       D       E       F       G      */
    /* 100- */ 015, 061, 062, 063, 064, 065, 066, 067,
    /*          H       I       J       K       L       M       N       O      */
    /* 110- */ 070, 071, 041, 042, 043, 044, 045, 046,
    /*          P       Q       R       S       T       U       V       W      */
    /* 120- */ 047, 050, 051, 022, 023, 024, 025, 026,
    /*          X       Y       Z       [       \       ]       ^       _      */
    /* 130- */ 027, 030, 031, 017, 075, 032, 076, 035,
    /*          `       a       b       c       d       e       f       g      */
    /* 140- */ 037, 061, 062, 063, 064, 065, 066, 067,
    /*          h       i       j       k       l       m       n       o      */
    /* 150- */ 070, 071, 041, 042, 043, 044, 045, 046,
    /*          p       q       r       s       t       u       v       w      */
    /* 160- */ 047, 050, 051, 022, 023, 024, 025, 026,
    /*          x       y       z       {       |       }       ~              */
    /* 170- */ 027, 030, 031, 037, 037, 037, 037, 037 
    };  
